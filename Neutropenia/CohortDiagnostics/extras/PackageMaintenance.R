...
#
# This file is part of phenotypeNeutropenia
#
...
styler::style_pkg()
OhdsiRTools::checkUsagePackage("phenotypeNeutropenia")
...
OhdsiRTools::createRenvLockFile(rootPackage = "phenotypeNeutropenia",
                                mode = "description",
